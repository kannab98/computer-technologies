\include{../../reports/preamble/preamble.tex}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{figs_20/obj_scatter.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{figs_20/sphere_scatter.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}{0.49\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{figs_20/tor_scatter.png}
        \caption{}
    \end{subfigure}
    \label{fig:scatter}
